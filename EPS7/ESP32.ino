...
http://192.168.xxx.xxx?ip                      //APIP, STAIP
...
http://192.168.xxx.xxx?servo=pin;value         // value= 0~180
http://192.168.xxx.xxx?relay=pin;value         // value = 0, 1
http://192.168.xxx.xxx?uart=value              //UART


http://192.168.xxx.xxx?framesize=value          // value = 10->UXGA(1600x1200), 9->SXGA(1280x1024), 8->XGA(1024x768) ,7->SVGA(800x600), 6->VGA(640x480), 5 selected=selected->CIF(400x296), 4->QVGA(320x240), 3->HQVGA(240x176), 0->QQVGA(160x120), 11->QXGA(2048x1564 for OV3660)
http://192.168.xxx.xxx?quality&val=value        // value = 10 ~ 63
http://192.168.xxx.xxx?brightness=value         // value = -2 ~ 2
http://192.168.xxx.xxx?contrast=value           // value = -2 ~ 2
http://192.168.xxx.xxx?saturation=value         // value = -2 ~ 2 
http://192.168.xxx.xxx?special_effect=value     // value = 0 ~ 6
http://192.168.xxx.xxx?hmirror=value            // value = 0 or 1 
http://192.168.xxx.xxx?vflip=value              // value = 0 or 1 
...
//WIFI
const char* ssid = "Kindy Markaz Yala_2.4G";
const char* password = "KL0502255163kl";
